    ...
    <aside class="sidebar">
        ...
        <nav>
            ...
            <a href="admin_notifications.php">
                ...
                <span id="sb-notif-badge" style="display:none;background:#dc2626;color:white;border-radius:10px;padding:1px 7px;font-size:10px;font-weight:800;margin-left:4px;vertical-align:middle;"></span>
            </a>
